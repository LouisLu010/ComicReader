...
enum ComicReaderSchemaV6: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [
            ...
            StoredComicShelf.self,
            StoredComicShelfMembership.self,
        ]
    }
    ...
    @Model
    final class StoredComicShelfMembership {
        ...
        init(
            ...
            membershipKey = shelfID.uuidString.lowercased()
                + "|"
                + comicID.uuidString.lowercased()
            self.shelfID = shelfID
            self.comicID = comicID
